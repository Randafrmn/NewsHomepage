			...
			<div className="container mx-auto md:px-36 px-4 py-8">
				<div className="grid md:grid-rows-[auto_auto] grid-rows-[auto_auto_auto] grid-flow-col gap-4">
					...
					<div className="col-span-2 flex md:flex-row flex-col md:justify-between md:gap-16 gap-2 md:mb-0 mb-6">
						<div className="">
							<span className="text-[2.5rem] leading-[2.5rem] font-extrabold">
					...
					<div className="md:row-span-2 col-span-2 md:col-span-1 bg-[#00001a] w-full">
						test Lorem ipsum dolor sit amet consectetur, adipisicing elit. Totam
						facere et minima exercitationem, molestiae ipsam doloribus dolorum
						nostrum ea! Placeat harum ratione amet nesciunt, exercitationem
						voluptatum illo? Quod, laborum veritatis?
					</div>
				</div>
